        ...
        <div className="container mx-auto py-6 flex justify-between items-center">
          <a href="/" className="relative w-[140px]">
            <svg xmlns="http://www.w3.org/2000/svg" width="134" height="97" fill="none" className="w-full max-w-full">
              ...
              />
              <path fill="#fff" fill-rule="evenodd" d="M4 29h126v44h-14v4h18V25H0v52h22v-4H4V29Z" clip-rule="evenodd" />
              <path
                fill="#fff"
              ...
              />
              <path fill="#fff" fill-rule="evenodd" d="M11.725 25 67 4.272 122.275 25h11.392L67 0 .333 25h11.392Z" clip-rule="evenodd" />
            </svg>
          </a>
